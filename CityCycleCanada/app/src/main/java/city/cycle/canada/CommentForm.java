...
public class CommentForm extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.comment_form_activity);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.list_stolen_bike) {
            Intent intent = new Intent(CommentForm.this, StolenBike.class);
            ...
            Intent intent = new Intent(CommentForm.this, HomeScreen.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
            finish();
        } else {
